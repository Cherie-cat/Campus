...
import Head from '../components/lostAndFound/head'
import Goods from '../components/lostAndFound/good'
import {goods} from '../data/lost/lostGoods'
import AddIcon from "../components/lostAndFound/addIcon";
  ...
  return(
    ...
    <Head navigation ={navigation}> </Head>
      ...
      <FlatList
        ...
        renderItem={({item})=>{
          return(
          <Goods navigation ={navigation} title = {item.title} context={item.context} url={item.url} time ={item.time} />
        );
        }}
